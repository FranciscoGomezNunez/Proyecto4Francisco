class Perder
{
  ...
  Perder(String press_, color col_, color col1_,color col2_,color col3_)
  {
    press=press_;
    col=col_;
    col1=col1_;
...
class Ganar
{
  ...
  Ganar(String press_, color col_, color col1_,color col2_,color col3_)
  {
    press=press_;
    col=col_;
    col1=col1_;
